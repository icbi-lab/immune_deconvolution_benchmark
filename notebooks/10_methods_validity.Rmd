...
immunedeconv::export_for_timer(schelker_ovarian$expr_mat, "../results/timer/methods_validity/input_ovarian_bulk.tsv")
immunedeconv::export_for_timer(bulk_sum, "../results/timer/methods_validity/input_ovarian_sum.tsv")

timer_res_bulk = immunedeconv::import_from_timer("../results/timer/methods_validity/result_ovarian_bulk.csv") %>%
  mutate(method="timer", source="bulk")
timer_res_sum = immunedeconv::import_from_timer("../results/timer/methods_validity/result_ovarian_sum.csv") %>%
  mutate(method="timer", source="sum")
...
all_results = bind_rows(all_results_bulk, all_results_simulated, timer_res_bulk, timer_res_sum) %>%
