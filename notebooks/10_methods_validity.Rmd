...
* correlation of simulated bulk samplese with a corresponding genuine bulk sample.
...
```{r, fig.width=8, fig.height=8, echo=FALSE, fig.cap="Correlation of simulated bulk samples of a certain immune cell type with immune cell reference samples"}
