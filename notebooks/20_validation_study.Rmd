...
```{r, fig.width=9, fig.height=4, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Comparison of absolute methods. The bars indicate the log2(slope). Values < 0 indicate an under-prediction of the cell type, values > 0 an over-prediction respectively. -Inf indicates that the correlation coefficient is negative. "}
log_slope %>%
...
```
```{r abs_rmse_val, fig.width=9, fig.height=4, echo=FALSE, message=FALSE, fig.cap="Comparison of absolute methods. The values show the RMSE"}
