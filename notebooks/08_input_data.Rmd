...
```{r hierarchy, fig.height=8, fig.width=14}
cell_type_hierarchy = new.env()
with(cell_type_hierarchy, {
  adj_list = read_excel("../tables/cell_type_mapping2.xlsx", sheet = "controlled_vocabulary") %>% select(parent, cell_type)
  tree = FromDataFrameNetwork(adj_list %>% as.data.frame())
  ...
  SetNodeStyle(tree, style = "filled,rounded", shape = "box", fillcolor = "GreenYellow", 
              fontname = "helvetica", tooltip = GetDefaultTooltip, color="black")
  plot(tree)
})
