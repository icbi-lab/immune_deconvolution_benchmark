...
```{r mixing_abs, echo=FALSE, cache=TRUE, warning=FALSE}
...
```
```{r abs_rmse, fig.width=9, fig.height=4, echo=FALSE, fig.cap="Comparison of absolute methods. The values show the RMSE"}
