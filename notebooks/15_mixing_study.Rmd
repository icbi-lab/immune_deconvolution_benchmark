...
```{r tumor_ct_fractions, results='hold', echo=FALSE, fig.cap="proportion of cell types by tumor sample"}
...
### Correlation plots
```{r mixing_correlation_plot, fig.width=18, fig.height=10, echo=FALSE, fig.cap="The figure shows the correlation of predicted vs. known fractions on 100 simulated bulk RNA seq samples."}
...
```{r, fig.width=8, fig.height=6, echo=FALSE, fig.cap="Comparison of absolute methods. The bars indicate the deviation from the perfect slope y=x"}
