...
immunedeconv::export_for_timer(eset_mat[,is_melanoma], path="../results/timer/mixing/input_melanoma.tsv")
immunedeconv::export_for_timer(eset_mat[,!is_melanoma], path="../results/timer/mixing/input_ovarian.tsv")

# run web here...

res_timer_melanoma = immunedeconv::import_from_timer("../results/timer/mixing/result_melanoma.csv")
res_timer_ovarian = immunedeconv::import_from_timer("../results/timer/mixing/result_ovarian.csv")
