...
#' @param k number of immune cells to use in the sample
#' @param background named vector giving cell counts of background cells. use `NULL` to exclude background cells. 
make_cell_fraction_vector = function(input_cell_type, k, background=cell_types$n_background_cells) {
