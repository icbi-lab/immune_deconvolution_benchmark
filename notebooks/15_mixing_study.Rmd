...
all_results = foreach(method=config$deconvolution_methods,
  ...
  deconvolute(bulk_eset, method, column="gene_symbol", indications = timer_indications, scale_mrna=TRUE)
}
```
...
```{r, fig.width=12, fig.height=4, echo=FALSE, fig.cap="Comparison of absolute methods. The bars indicate the log2(slope). Values < 0 indicate an under-prediction of the cell type, values > 0 an over-prediction respectively. "}
log_slope %>%
