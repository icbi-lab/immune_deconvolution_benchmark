...
method_names %<>% left_join(data.frame(method=names(method_abbrev), method_abbrev=method_abbrev)) %>%
  mutate(method_abbrev = if_else(is.na(method_abbrev), substr(method, 0, 2), method_abbrev))
